  ...
  return(
    <section>
        <div className='font-sans flex justify-center items-center flex-col select-none'>
          <h1 className='absolute drop-shadow-2xl text-3xl lg:text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 top-2/4'>README Components</h1>
          <p className="absolute top-[57%] lg:top-[70%] font-semibold text-[13px] lg:text-2xl">Dale un toque de vida a tus archivos <code>markdown.md</code></p>
