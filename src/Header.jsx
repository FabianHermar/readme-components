          ...
          <div className='flex items-center justify-between'>
            <div className='relative z-20'>
              <a href='#' className='flex items-center justify-center'>
                ...
                />
                <p className='font-sans text-gray-500 lg:text-white font-semibold drop-shadow'>
                  RC.md
                </p>
              </a>
            </div>
                ...
                <div className='flex flex-col h-full lg:flex-row jusfify-between lg:items-center'>
                  <ul className='px-6 pt-32 text-black font-sans font-semibold space-y-8 lg:space-y-0 md:px-12 lg:flex lg:space-x-12 lg:pt-0 font-xl'>
                    <li>
                      <a
                        href='#'
                        className='group relative before:absolute before:inset-x-0 before:bottom-0 hover:underline hover:decoration-purple-300 hover:decoration-4 before:h-2 before:origin-right before:scale-x-0 before:transition before:duration-200 hover:before:origin-left hover:before:scale-x-100'
                      >
                        <span className='relative text-black lg:text-white ease-in duration-200'>
                          Inicio
                        </span>
                      </a>
                    </li>
                    ...
                    <li>
                      <details className='group relative'>
                        <summary className='flex cursor-pointer list-none items-center justify-between lg:text-white'>
                          Más Opciones
                          <svg
                            data-hk='0-0'
                            width='18'
                            ...
                            className='inline-block rotate-0 transition-transform group-open:-rotate-180 ml-2 lg:text-white'
                          >
                            <path
                              d='M1 1L11 11L21 1'
                              stroke='currentColor'
                        ...
                        <div className='mt-[25px] flex flex-col gap-4 text-md font-sans absolute lg:backdrop-blur lg:bg-white/50 px-6 py-2 lg:text-center lg:text-white'>
                          <a
                            ...
                            target='_blank'
                            className='flex items-center gap-4 lg:hover:underline hover:decoration-2'
                          >
                            Web Personal
                          </a>
                          <a
