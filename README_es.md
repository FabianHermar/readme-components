...
[⬆ Ir a las categorías](https://github.com/FabianHMzz/readme-components/blob/main/README_es.md#-categor%C3%ADas)
...
```diff
! Para una mejor compatibilidad al usar colores, usar colores hexadecimales.
```
